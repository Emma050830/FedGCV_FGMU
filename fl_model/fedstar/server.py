import torch
from FGMU.fl_model.base import BaseServer
from FGMU.fl_model.fedstar._utils import init_structure_encoding
from FGMU.fl_model.fedstar.gin_dc import serverGIN_dc,DecoupledGIN
from FGMU.fl_model.fedstar.fedstar_config import config
