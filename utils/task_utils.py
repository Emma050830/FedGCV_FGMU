...
def load_graph_cls_default_model(args, input_dim, output_dim, client_id=None):
    ...
    if model_name == "gin":
        from FGMU.graph_model.gin import GIN
        ...
        from FGMU.graph_model.global_edge import GlobalEdge
        ...
        from FGMU.graph_model.global_pan import GlobalPAN
        ...
        from FGMU.graph_model.global_sag import GlobalSAG
...
def load_node_edge_level_default_model(args, input_dim, output_dim, client_id=None):
    ...
    if client_id is None: # server
        ...
        if len(args.model) > 1:
            ...
            model_name = args.model[0]
    if model_name == "mlp":
        from FGMU.graph_model.mlp import MLP
        ...
        from FGMU.graph_model.gcn import GCN
        ...
        from FGMU.graph_model.gat import GAT
        ...
        from FGMU.graph_model.graphsage import GraphSAGE
        ...
        from FGMU.graph_model.sgc import SGC
        ...
        from FGMU.graph_model.gcn2 import GCN2
