...
from FGMU.data.global_dataset_loader import load_global_dataset
...
class FGLDataset(Dataset):
    ...
    def check_args(self, args):
        ...
        if args.scenario == "graph_fl":
            from FGMU.config import supported_graph_fl_datasets, supported_graph_fl_simulations, supported_graph_fl_task
            ...
            from FGMU.config import supported_subgraph_fl_datasets, supported_subgraph_fl_simulations, supported_subgraph_fl_task
            for dataset in args.dataset:
