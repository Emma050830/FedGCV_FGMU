...
def processing(args: argparse.ArgumentParser, splitted_data, processed_dir, client_id):
    ...
    if args.processing == "raw" or client_id is None: # no processing or global data
        ...
        from FGMU.data.data_processing import random_feature_noise
        ...
        from FGMU.data.data_processing import random_topology_sparsity
        ...
        from FGMU.data.data_processing import random_topology_noise
        ...
        from FGMU.data.data_processing import random_label_sparsity
        ...
        from FGMU.data.data_processing import random_label_noise
